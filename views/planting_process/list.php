                                           ...
                                           $no = 1;
                                            ...
                                            <tr>
                                              ...
                                              <td style="text-align:center;">
                                                    ...
                                                    <a href="planting_process.php?page=form&id=<?= $row['planting_process_id']?>" class="btn btn-default" ><i class="fa fa-pencil"></i></a>
                                                    <a href="javascript:void(0)" onclick="confirm_delete(<?= $row['planting_process_id']; ?>,'planting_process.php?page=delete&id=')" class="btn btn-default" ><i class="fa fa-trash-o"></i></a>
